...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Input2Nums_t, stringdata) + ofs \
...
const QMetaObject Input2Nums::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Input2Nums.data,
      qt_meta_data_Input2Nums,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Input2Nums.stringdata))

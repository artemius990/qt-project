...
#include "../../FirstProject/dialogsettings.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DialogSettings_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 35, 31),
QT_MOC_LITERAL(5, 67, 5)
    },
    "DialogSettings\0slot1\0\0loadSettings\0"
...
const QMetaObject DialogSettings::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DialogSettings.data,
      qt_meta_data_DialogSettings,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DialogSettings.stringdata))

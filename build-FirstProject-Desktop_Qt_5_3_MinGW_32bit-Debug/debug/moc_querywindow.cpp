...
#include "../../FirstProject/querywindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QueryWindow_t, stringdata) + ofs \
...
const QMetaObject QueryWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_QueryWindow.data,
      qt_meta_data_QueryWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QueryWindow.stringdata))

...
#include "../../FirstProject/tablewindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TableWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 39, 28)
    },
    "TableWindow\0on_actionAddRow_triggered\0"
    "\0on_actionRemoveRow_triggered"
};
...
void TableWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_actionRemoveRow_triggered(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject TableWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_TableWindow.data,
      qt_meta_data_TableWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TableWindow.stringdata))
